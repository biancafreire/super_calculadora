document.getElementById('calculate-button').onclick = function () {
	...
	// Coleta números dentro das caixas
	...
	// Setting the proper resultElement inner text if a number is not typed
		if (val1 !== val1) {
			resultElement.innerText = "opa, algo não está certo! insira números válidos";
			document.getElementById("elem-1").focus();
		} else if(val2 !== val2) {
			resultElement.innerText = "opa, algo deu errado! insira números válidos";
